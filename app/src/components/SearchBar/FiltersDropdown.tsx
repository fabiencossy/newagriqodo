...
export function FiltersDropdown({
  ...
  return (
    <div
      role="menu"
      className="absolute top-full right-0 left-0 z-[1000] mt-1 grid max-w-[720px] grid-cols-1 rounded-(--radius) border border-(--color-border) bg-(--color-surface) shadow-(--shadow-popup) sm:grid-cols-3"
    >
