# AGRICODO V2 — SPECIFICATION COMPLÈTE
...
```
┌─────────────────────────────────────────────────────────┐
│          AGRICODO v2 - MULTI-EXPLOITATION                │
└─────────────────────────────────────────────────────────┘
         │                    │                    │
         ▼                    ▼                    ▼
  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐
...
- Odoo articles → Agricodo cultures (tags "agriculture")
...
**Odoo → Agricodo (PULL, webhook-triggered)**
...
- Commandes travaux : crée entrée Agricodo
- Délais d'attente produits : field Odoo → alert config

**Agricodo → Odoo (PUSH, webhook + API)**
...
Stockés Odoo, synchronisés Agricodo:
```json
{
  "product_id": 123,
  "name": "Glyphosate 360",
