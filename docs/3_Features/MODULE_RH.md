...
```
AGRICODO V2 — NAVIGATION MENU HAMBURGER
...
3. Agricodo sync : pull leaveRequest Odoo → LeaveRequest table
4. Dashboard affiche congés approuvés
5. Heures dues recalculées automatiquement
```

**Note:** Agricodo NE CRÉE PAS les demandes (Odoo only)
...
**Si sync conflict (modification Odoo + Agricodo):**
- **Odoo wins** pour employee data (contrats, taux)
- **Agricodo wins** pour timesheet (source de saisie)
