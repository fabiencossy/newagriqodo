# AGENTS.MD — DÉFINITION DES 5 AGENTS AGRICODO V2
...
- Écrit **mappings données** (Odoo article → Agricodo culture)
- Écrit **job queue logic** (Bull, retry, idempotency)
- Gère **conflict resolution** (modification simultanée Agricodo + Odoo)
- Écrit **audit logs** (qui a sync quoi, quand)
- Teste **sync bidirectionnelle** (Odoo → Agricodo → Odoo OK?)
...
**Contexte:**
- Projet: Agricodo v2 (app gestion parcelles agricoles suisses)
